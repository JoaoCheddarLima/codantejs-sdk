...
export class CodanteOlympicsClient {
    ...
    static olympics = {
         ...
         */
        events: async (params?: EventOptionalParams): Promise<EventsResponse> => {
            if (params) {
         ...
         */
        event: async (id: string): Promise<EventResponse> => {
         ...
         */
        venues: async (): Promise<VenueResponse> => {
         ...
         */
        disciplines: async (): Promise<DisciplineResponse> => {
         ...
         */
        countries: async (page: number = 1): Promise<CountryResponse> => {
